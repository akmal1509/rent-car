<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ $type_menu === 'car' ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-car"></i>
                    <span>Car</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('admin/cars') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ url('admin/car') }}">Master Data</a>
                    </li>
                    <li class="{{ Request::is('admin/cars/create') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ url('admin/cars/create') }}">Add Data</a>
                    </li>
            ...
            <li class="nav-item dropdown {{ $type_menu === 'blog' ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i>
                    <span>Blog</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('admin/blog') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ url('admin/blog') }}">Master Data</a>
                    </li>
                    <li class="{{ Request::is('admin/blog/create') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ url('admin/blog/create') }}">Add Data</a>
                    </li>
